//
//  EIPTechnicalSkillsViewController.m
//  EIPortafolio
//
...
@interface EIPTechnicalSkillsViewController ()

@end

@implementation EIPTechnicalSkillsViewController
...
- (IBAction)showPrevFromSwipeRecognizer:(UISwipeGestureRecognizer *)recognizer {
    ...
    EIPEstampWorldViewController *viewController = [storyboard instantiateViewControllerWithIdentifier:@"EIPEstampWorldViewController"];
...
- (IBAction)showUpFromSwipeRecognizer:(UISwipeGestureRecognizer *)recognizer {
    ...
    viewController.previousScreen = @"EIPTechnicalSkillsViewController";
