...
@interface EIPInterestsViewController ()

@end

@implementation EIPInterestsViewController
...
- (IBAction)showUpFromSwipeRecognizer:(UISwipeGestureRecognizer *)recognizer {
    ...
    viewController.previousScreen = @"EIPInterestsViewController";
