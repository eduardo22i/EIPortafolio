//
//  EIPTechnicalSkillsBViewController.m
//  EIPortafolio
//
...
@interface EIPTechnicalSkillsBViewController ()

@end

@implementation EIPTechnicalSkillsBViewController
...
- (IBAction)showUpFromSwipeRecognizer:(UISwipeGestureRecognizer *)recognizer {
    ...
    viewController.previousScreen = @"EIPTechnicalSkillsBViewController";
