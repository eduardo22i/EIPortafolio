...
@interface EIPUniversityViewController ()

@end

@implementation EIPUniversityViewController
...
- (IBAction)showUpFromSwipeRecognizer:(UISwipeGestureRecognizer *)recognizer {
    ...
    viewController.previousScreen = @"EIPUniversityViewController";
